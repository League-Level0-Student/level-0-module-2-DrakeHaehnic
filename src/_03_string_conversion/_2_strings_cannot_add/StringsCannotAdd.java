...
public class StringsCannotAdd {
		...
		String four =	JOptionPane.showInputDialog("ah (6)");
		String six =	JOptionPane.showInputDialog("ah (4)");
		...
		String five =	JOptionPane.showInputDialog("ah choo(5)");
			...
			int sixInt = Integer.parseInt(six);
		...
		int fiveInt = Integer.parseInt(five);
			...
			JOptionPane.showMessageDialog(null, fourInt + sixInt + fiveInt);
